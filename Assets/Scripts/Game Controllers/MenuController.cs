...
public class MenuController : MonoBehaviour {
    ...
    public static GameObject[] copyOfBirds;
    ...
    {
        SocialMediaController.instance.LogInOrLogOutFacebook();
    }

    public void ShareToFacebook()
    {
        SocialMediaController.instance.ShareToFacebook();
    }
